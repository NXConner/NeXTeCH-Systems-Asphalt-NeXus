...
export default function Settings() {
  const [settings, setSettings] = useState(() => {
    ...
    return saved ? JSON.parse(saved) : {
      company: { name: "AsphaltPro Construction", address: "123 Industrial Blvd, Construction City, CC 12345", phone: "(555) 123-4567", email: "info@asphaltpro.com", website: "www.asphaltpro.com", taxId: "12-3456789", license: "CC-ASPHALT-2024" },
      user: { name: "John Admin", email: "admin@asphaltpro.com", phone: "(555) 987-6543", role: "admin", notifications: true, darkMode: true, language: "en" },
      fleet: { autoTracking: true, maintenanceAlerts: true, fuelTracking: true, driverScoring: true, geofencing: true, idleTimeLimit: 15 },
      employee: { timeTracking: true, autoClockout: 8, overtimeAlerts: true, vacationApproval: "manager", performanceReviews: true, documentReminders: true },
      mapping: { defaultZoom: 15, showTraffic: true, autoDetection: true, confidenceThreshold: 85, employeeTracking: true, routeOptimization: true },
      financial: { currency: "USD", taxRate: 8.5, paymentTerms: "Net 30", autoInvoicing: false, approvalRequired: true, budgetAlerts: true },
      integrations: { quickbooks: false, gps: true, weather: true, emailNotifications: true, smsAlerts: false, backupFrequency: "daily" }
    };
  });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2 border rounded"
                    title="Select vacation approval method"
                    aria-label="Select vacation approval method"
                  >
